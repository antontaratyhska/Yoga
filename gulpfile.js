...
var devPaths = {
  ...
  allCss: 'Yoga/scss/bower.scss',
  scss: 'Yoga/scss_/',
  css: 'Yoga/css/',
  scripts: 'Yoga/js/',
  images: 'Yoga/img/*',
  fonts: 'Yoga/fonts/GT_Walsheim/',
  html: 'Yoga/',
  footerFolder: 'Yoga/',
  footerTpl: 'Yoga/*.html'
}
...
gulp.task('move_share', function() {
  return gulp.src(devPaths.scripts + 'socialShare.min.js')
...
gulp.task('build', function(callback) {
  ...
  runSequence(
    'clean:dist',
    'sass',
    ['useref', 'images', 'fonts', "move_css","move_share"],
    callback
  )
})